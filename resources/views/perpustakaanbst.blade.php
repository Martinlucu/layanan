        ...
        <tr>
                  ...
                  <tbody>
                    ...
                    @IF ($ks->status == 'setuju by dosen')
                      ...
                      <td>{{ $ks->nama_mhs }}</td>
                      <td>{{ $ks->jurusan }}</td>
                      <td>{{ $ks->alasan_pengajuan }}</td>
                      <td>{{ $ks->created_at }}</td>
                      <td>Disetujui oleh dosen</td>
                      <td>{{ $ks->updated_at}}</td>
                    @ELSEIF ($ks->status == 'setuju by kaprodi')
                      <input type="hidden" name="id" value="{{ $ks->id }}">
                      <td>{{ $ks->nim }}</td>
                      <td>{{ $ks->nama_mhs }}</td>
                      <td>{{ $ks->jurusan }}</td>
                    ...
                    @ELSEIF ($ks->status == 'selesai')
                      ...
                      <td>Selesai</td>
                      <td>{{ $ks->updated_at}}</td>
                      @ELSEIF ($ks->status == 'ditolak by dosen')
                      <input type="hidden" name="id" value="{{ $ks->id }}">
                      <td>{{ $ks->nim }}</td>
                      <td>{{ $ks->nama_mhs }}</td>
                      <td>{{ $ks->jurusan }}</td>
                      <td>{{ $ks->alasan_pengajuan }}</td>
                      <td>{{ $ks->created_at}}</td>
                      <td>Ditolak karena {{$ks->alasan_penolakan}}</td>
                      <td>{{ $ks->updated_at}}</td>
                      @ELSEIF ($ks->status == 'ditolak by kaprodi')
                      <input type="hidden" name="id" value="{{ $ks->id }}">
                      <td>{{ $ks->nim }}</td>
                      <td>{{ $ks->nama_mhs }}</td>
                      <td>{{ $ks->jurusan }}</td>
