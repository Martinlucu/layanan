	...
	<div class="modal-dialog modal-xl">
        ...
        <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                    <?php $__currentLoopData = $dispmaha; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $di): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td><?php echo e($di->nim); ?></td>
		              	<td><?php echo e($di->nama_mhs); ?></td>
			             
		              	<td><?php echo e($di->jurusan); ?></td>
                    <td><?php echo e($di->created_at); ?></td>
                    <td><?php echo e($di->updated_at); ?></td>
                    </tr>
	...
	<div class="modal-dialog modal-xl">
        ...
        <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                    <?php $__currentLoopData = $dis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td><?php echo e($diss->nim); ?></td>
		              	<td><?php echo e($diss->nama_mhs); ?></td>
			            
		              	<td><?php echo e($diss->jurusan); ?></td>
		              	<td><?php echo e($diss->created_at); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </tbody>
                </table>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card card-warning">
              ...
              ?>
             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
             <?php $__currentLoopData = $datedis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
              $dip= $d->created_at;
              ?>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script src="<?php echo e(asset('js/pureknob.js')); ?>"></script>
...
<?php echo $__env->make('layouts.top', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\layanan\resources\views/dashdispen.blade.php ENDPATH**/ ?>