        ...
        <tr>
                  ...
                  <tbody>
                    ...
                    <td><?php echo e($d->nim); ?></td>
		              	...
		              	<td> <a class="btn btn-success" href="<?php echo e(url('/dosdetdispen/dosstjdis/'.$d->id)); ?>">Setuju
                    <a class="btn btn-danger" href="<?php echo e(url('/dosdetdispen/dostlkdis/'.$d->id)); ?>">Tolak
                  </td>
                    </tr>
    ...
    <div class="table-responsive" style="padding:20px;width: 98%;">
      ...
      <thead>
        <tr>
                  ...
                  <tbody>
                    <tr>
                    <?php $__currentLoopData = $dpmahas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo e(csrf_field()); ?>

                    <input type="hidden" name="id" value="<?php echo e($ds->id); ?>">
                    <td><?php echo e($ds->nim); ?></td>
		              	<td><?php echo e($ds->nama_mhs); ?></td>
		              	<td><?php echo e($ds->jurusan); ?></td>
		              	<td><?php echo e($ds->alasan_pengajuan); ?></td>
		              	<td><?php echo e($ds->created_at); ?></td>
...
<?php echo $__env->make('layouts.topdos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\layanan\resources\views/dosdetdispen.blade.php ENDPATH**/ ?>