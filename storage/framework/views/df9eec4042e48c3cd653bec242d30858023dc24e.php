        ...
        <tr>
                  ...
                  <tbody>
                    ...
                    <td><?php echo e($yd->nim); ?></td>
		              	...
		              	<td> <a class="btn btn-success" href="<?php echo e(url('/dosdetyudi/dosstjyudi/'.$yd->id)); ?>">Setuju
                    <a class="btn btn-danger" href="<?php echo e(url('/dosdetyudi/dostlkyudi/'.$yd->id)); ?>">Tolak
                  </td>
                    </tr>
    ...
    <div class="table-responsive" style="padding:20px;width: 98%;">
      ...
      <thead>
        <tr>
                  ...
                  <tbody>
                    <tr>
                    <?php $__currentLoopData = $ydmahas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo e(csrf_field()); ?>

                    <input type="hidden" name="id" value="<?php echo e($ys->id); ?>">
                    <td><?php echo e($ys->nim); ?></td>
		              	<td><?php echo e($ys->nama_mhs); ?></td>
		              	<td><?php echo e($ys->jurusan); ?></td>
		              	<td><?php echo e($ys->alasan_pengajuan); ?></td>
		              	<td><?php echo e($ys->created_at); ?></td>
		              	<?php if($ys->status == 'selesai'): ?>
                      <td>Disetujui</td>
                    <?php else: ?>
                      <td>Disetujui</td>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.topdos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\layanan\resources\views/dosdetyudi.blade.php ENDPATH**/ ?>